            ...
            {            	
                if (!currentUser.getAccountSetUp() && code.equals("123")) {
                	...
                	if (currentUser.getReset()) {
                		System.out.println("in reset func");
                        System.out.print(currentUser.deadLine);
                    	...
                    	else if(currentUser.deadLine.isBefore(LocalDateTime.now()) && !(currentUser.getReset())) {
                    		System.out.println("in after");
                    		messageLabel.setText("ResetDeadline has passed." );
                    		currentUser.undoReset();
                    	}		
                	} else {
